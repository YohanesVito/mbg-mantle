// Mirrored from be/src/protocols/registry.ts — keep in sync.
// fe/ only needs registry metadata for display, not the scoring engine,
// so we duplicate types + data here to keep fe/ self-contained for Vercel deploy.
